...
![App Screenshot](./assets/img/Screenshot_14.png?raw=true)

### Quick Sort:

![App Screenshot](./assets/img/Screenshot_15.png?raw=true)

### Insertion Sort:

![App Screenshot](./assets/img/Screenshot_16.png?raw=true)

### Bubble Sort:

![App Screenshot](./assets/img/Screenshot_17.png?raw=true)

### Merge Sort:

![App Screenshot](./assets/img/Screenshot_18.png?raw=true)

### Heap Sort:

![App Screenshot](./assets/img/Screenshot_19.png?raw=true)

### And this is an image where the list is sorted

![App Screenshot](./assets/img/Screenshot_20.png?raw=true)
