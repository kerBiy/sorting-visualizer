...
void OptionManager::updateOptions(int algorithm) {
    m_menu->clear();
    switch (algorithm) {
        case BUBBLE_SORT:m_menu->addItem("Upwards");
            ...
            break;
        case QUICK_SORT:m_menu->addItem("Naive Partition");
            ...
            break;
        case MERGE_SORT:m_menu->addItem("Standard");
            ...
            break;
        case RADIX_SORT:m_menu->addItem("Base 2 LSD");
            m_menu->setItemData(0, "Ω(n log n) | Θ(n log n) | O(n log n) || O(n)", Qt::ToolTipRole);
            ...
            break;
        case BUCKET_SORT:m_menu->addItem("Bucket");
        ...
        case HEAP_SORT:m_menu->addItem("Max heap");
            ...
            break;
        case SELECTION_SORT:m_menu->addItem("Select max");
            m_menu->setItemData(0, "Ω(n²) | Θ(n²) | O(n²) || O(1)", Qt::ToolTipRole);
            ...
            break;
        case SORTING_NETWORKS:m_menu->addItem("Bitonic sort");
            ...
            break;
        case STUPID_SORTS:m_menu->addItem("Slowsort");
            m_menu
                ->setItemData(0, "Ω(n^(log n / 2)) | Θ(n^(log n / 2)) | O(n^(log n / 2)) || O(log n)", Qt::ToolTipRole);
